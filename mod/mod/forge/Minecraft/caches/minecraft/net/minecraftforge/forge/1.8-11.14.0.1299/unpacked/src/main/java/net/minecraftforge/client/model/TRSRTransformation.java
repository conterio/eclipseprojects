...
public class TRSRTransformation implements IModelState, ITransformation
{
    ...
    {
        this(transform.field_178365_c, quatFromYXZ(transform.field_178364_b), transform.field_178363_d, null);
    }

    public TRSRTransformation(ModelRotation rotation)
    {
        this(new Matrix4f(rotation.func_177525_a()));
    }
    ...
    {
        Vector4f vec = new Vector4f(facing.func_176730_m().func_177958_n(), facing.func_176730_m().func_177956_o(), facing.func_176730_m().func_177952_p(), 1);
        matrix.transform(vec);
        return EnumFacing.func_176737_a(vec.x / vec.w, vec.y / vec.w, vec.z / vec.w);
    }
