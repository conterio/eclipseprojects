...
public class ItemFluidContainer extends Item implements IFluidContainerItem
{
    ...
    {
        if (!container.func_77942_o() || !container.func_77978_p().func_74764_b("Fluid"))
        {
            return null;
        }
        return FluidStack.loadFluidStackFromNBT(container.func_77978_p().func_74775_l("Fluid"));
    }
    ...
    public int fill(ItemStack container, FluidStack resource, boolean doFill)
    {
        ...
        if (!doFill)
        {
            ...
            FluidStack stack = FluidStack.loadFluidStackFromNBT(container.func_77978_p().func_74775_l("Fluid"));
        ...
        if (!container.func_77978_p().func_74764_b("Fluid"))
        {
            ...
            if (capacity < resource.amount)
            {
                ...
                container.func_77978_p().func_74782_a("Fluid", fluidTag);
                return capacity;
            }
        ...
        container.func_77978_p().func_74782_a("Fluid", stack.writeToNBT(fluidTag));
        return filled;
    }
