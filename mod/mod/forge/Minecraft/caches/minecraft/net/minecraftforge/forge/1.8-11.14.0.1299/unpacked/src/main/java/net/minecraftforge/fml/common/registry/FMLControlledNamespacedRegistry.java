...
public class FMLControlledNamespacedRegistry<I> extends RegistryNamespacedDefaultedByKey {
     ...
     */
    @Override
    public I func_82594_a(Object name)
    {
        I object = null;
    ...
    {
        I ret = superType.cast(super.func_82594_a(loc));
     ...
     */
    @Override
    public boolean func_148741_d(Object name)
    {
    ...
    public void serializeInto(Map<String, Integer> idMapping) // for saving
    {
        ...
        {
            idMapping.put(func_177774_c(thing).toString(), getId(thing));
        }
    }
    ...
    private void addObjectRaw(int id, Object name, I thing)
    {
        ...
        field_148759_a.func_148746_a(thing, id); // obj <-> id
        super.func_82595_a(name, thing); // name <-> obj
    }
