...
public class GameData {
    ...
    static Block findBlock(String modId, String name)
    {
        ...
        return getMain().iBlockRegistry.func_148741_d(key) ? getMain().iBlockRegistry.func_82594_a(key) : null;
    }
    ...
    private int registerBlock(Block block, String name, int idHint)
    {
        ...
        {
            GameData.BLOCKSTATE_TO_ID.func_148746_a(state, blockId << 4 | block.func_176201_c(state));
        }
    ...
    {
        Object blockName = iBlockRegistry.func_177774_c(item.field_150939_a);
