    ...
    public void func_73863_a(int p_571_1_, int p_571_2_, float p_571_3_)
    {
        ...
        if (selectedMod != null) {
            ...
            if (!selectedMod.getMetadata().autogenerated) {
                ...
                if (!logoFile.isEmpty())
                {
                    ...
                    try
                    {
                        ...
                        if (cachedLogo != null)
                        {
                            ...
                            world.func_178970_b();
                            world.func_178985_a(offset,                               top + cachedLogoDimensions.height,  field_73735_i, 0, 1);
                            world.func_178985_a(offset + cachedLogoDimensions.width,  top + cachedLogoDimensions.height,  field_73735_i, 1, 1);
                            world.func_178985_a(offset + cachedLogoDimensions.width,  top,                                field_73735_i, 1, 0);
                            world.func_178985_a(offset,                               top,                                field_73735_i, 0, 0);
                            tess.func_78381_a();
                ...
                this.field_146289_q.func_175063_a(selectedMod.getMetadata().name, offset, shifty, 0xFFFFFF);
                shifty += 12;
