...
public class GuiIngameForge extends GuiIngame
{
    ...
    public void func_175180_a(float partialTicks)
    {
        ...
        {
            func_180480_a(field_73839_d.field_71439_g.func_70013_c(partialTicks), res);
        }
        else
        {
    ...
    protected void renderCrosshairs(int width, int height)
    {
        ...
        if (this.func_175183_b())
        {
            ...
            GlStateManager.func_179147_l();
            GlStateManager.func_179120_a(GL11.GL_ONE_MINUS_DST_COLOR, GL11.GL_ONE_MINUS_SRC_COLOR, 1, 0);
            GlStateManager.func_179141_d();
    ...
    private void renderHelmet(ScaledResolution res, float partialTicks)
    {
        ...
        if (this.field_73839_d.field_71474_y.field_74320_O == 0 && itemstack != null && itemstack.func_77973_b() != null)
        {
            ...
            {
                itemstack.func_77973_b().renderHelmetOverlay(itemstack, field_73839_d.field_71439_g, res, partialTicks);
            }
        }
    ...
    public void renderHealth(int width, int height)
    {
        ...
        int regen = -1;
        if (player.func_70644_a(Potion.field_76428_l))
        {
        ...
        int MARGIN = 16;
        if (player.func_70644_a(Potion.field_76436_u))      MARGIN += 36;
        else if (player.func_70644_a(Potion.field_82731_v)) MARGIN += 72;
    ...
    protected void renderRecordOverlay(int width, int height, float partialTicks)
    {
        if (field_73845_h > 0)
        {
            ...
            {
                GlStateManager.func_179094_E();
                GlStateManager.func_179109_b((float)(width / 2), (float)(height - 48), 0.0F);
                GlStateManager.func_179147_l();
                GlStateManager.func_179120_a(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA, 1, 0);
    ...
    protected void renderChat(int width, int height)
    {
        ...
        GlStateManager.func_179094_E();
        GlStateManager.func_179109_b((float)event.posX, (float)event.posY, 0.0F);
