...
public class OreDictionary
{
    ...
    public static void initVanillaEntries()
    {
        ...
        ItemStack[] exclusions = new ItemStack[]
        {
            ...
            new ItemStack(Blocks.field_150376_bx),
    ...
    {
        if (stack == null || stack.func_77973_b() == null) throw new IllegalArgumentException("Stack can not be null!");
    ...
    public static boolean itemMatches(ItemStack target, ItemStack input, boolean strict)
    {
        ...
        return (target.func_77973_b() == input.func_77973_b() && ((target.func_77952_i() == WILDCARD_VALUE && !strict) || target.func_77952_i() == input.func_77952_i()));
    }
