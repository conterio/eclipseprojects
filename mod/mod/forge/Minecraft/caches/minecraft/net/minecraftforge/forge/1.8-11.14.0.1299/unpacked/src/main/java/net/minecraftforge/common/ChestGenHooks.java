...
public class ChestGenHooks
{
    ...
    public void removeItem(ItemStack item)
    {
        ...
        while(itr.hasNext())
        {
            ...
            if (item.func_77969_a(cont.field_76297_b) || (item.func_77952_i() == OreDictionary.WILDCARD_VALUE && item.func_77973_b() == cont.field_76297_b.func_77973_b()))
            {
                itr.remove();
            }
        }
    ...
    {
        WeightedRandomChestContent item = (WeightedRandomChestContent)WeightedRandom.func_76271_a(rand, getItems(rand));
        ItemStack[] stacks = ChestGenHooks.generateStacks(rand, item.field_76297_b, item.field_76295_d, item.field_76296_e);
